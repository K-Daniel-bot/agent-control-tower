      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span
              style={{
                fontSize: 10, fontWeight: 600, color: categoryColor,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            >
              <span style={{ fontSize: 16 }}>{article.saved ? '\u2605' : '\u2606'}</span>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 2, color: '#888', cursor: 'pointer',
        ...
        >
          ...
          <h2
            style={{
              fontSize: 20, fontWeight: 700, color: '#e0e0e0',
              margin: '0 0 12px 0', lineHeight: 1.4, letterSpacing: -0.3,
            }}
          >
            {article.title}
          </h2>
          ...
          >
            <span style={{ fontSize: 11, color: '#00ff88', fontFamily: 'monospace', fontWeight: 600 }}>
              {article.source}
            </span>
          ...
          <div style={{ height: 1, backgroundColor: '#333333', margin: '0 0 16px 0' }} />

          {/* Article content */}
          <div
            style={{
              fontSize: 13, color: '#bbb', lineHeight: 1.9,
              marginBottom: 20, fontFamily: 'monospace', whiteSpace: 'pre-wrap',
            }}
          >
            {article.content ?? article.summary}
          </div>

          {/* Original article link - enhanced modal display */}
          {article.originalUrl && (
            <div
              style={{
                marginBottom: 20,
            ...
            >
              <div style={{ fontSize: 10, color: '#555', fontFamily: 'monospace', letterSpacing: 1, marginBottom: 8 }}>
                원본 기사 출처
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                <svg width="14" height="14" viewBox="0 0 12 12" fill="none">
                  <path d="M5 1H2C1.45 1 1 1.45 1 2V10C1 10.55 1.45 11 2 11H10C10.55 11 11 10.55 11 10V7" stroke="#00ff88" strokeWidth="1.2" strokeLinecap="round" />
                  <path d="M7 1H11V5" stroke="#00ff88" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M11 1L5.5 6.5" stroke="#00ff88" strokeWidth="1.2" strokeLinecap="round" />
                </svg>
                <span
                  style={{
              ...
              <a
                ...
                style={{
                  ...
                  borderRadius: 2, color: '#00ff88',
                  fontSize: 10, fontFamily: 'monospace',
                  textDecoration: 'none', cursor: 'pointer',
                  transition: 'all 0.15s',
                }}
                onMouseEnter={(e) => {
                  ;(e.target as HTMLAnchorElement).style.background = 'rgba(0, 255, 136, 0.2)'
                }}
                onMouseLeave={(e) => {
                  ;(e.target as HTMLAnchorElement).style.background = 'rgba(0, 255, 136, 0.1)'
                }}
              >
                새 탭에서 열기 ↗
              </a>
          ...
          <div style={{ borderTop: '1px solid #333333', paddingTop: 16 }}>
            <div
              style={{
                display: 'flex', alignItems: 'center',
            ...
            >
              ...
              {analysisState === 'idle' && (
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: 0.5, transition: 'background-color 0.2s',
                  }}
                  onMouseEnter={(e) => {
                    ;(e.target as HTMLButtonElement).style.backgroundColor = 'rgba(0, 255, 136, 0.1)'
                  }}
                  onMouseLeave={(e) => {
              ...
              {analysisState === 'complete' && (
                <span style={{ fontSize: 11, color: '#00ff88', fontFamily: 'monospace', letterSpacing: 0.5 }}>
                  {'\u2713'} 분석 완료
                </span>
              )}
            </div>
            ...
            {analysis !== null && analysisState === 'complete' && (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                  <span style={{ fontSize: 10, color: '#555', fontFamily: 'monospace', letterSpacing: 1, width: 60 }}>
                    SENTIMENT
                  </span>
                  <span
                    style={{
                      fontSize: 12, color: SENTIMENT_LABELS[analysis.sentiment].color,
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  <span
                    style={{
                      ...
                      letterSpacing: 1, width: 60, flexShrink: 0, paddingTop: 2,
                    }}
                  >
                    KEYWORDS
                  </span>
